...
var (
	...
	allowed    = map[Action]SubjectKind{
		...
		UnitReviewRecorded: Review, UnitCompleted: WorkUnit, AggregateReviewRecorded: Artifact, ContinuationRecorded: Artifact, ProgressRecorded: Artifact, CapabilityRequested: Artifact,
	}
)
