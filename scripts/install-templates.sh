...
- When a required tool, command, or transition is absent, sub-agents surface it to Daimon and Daimon uses `workflow request-capability`; agents must not invent or bypass it, and the request does not imply fulfillment.
